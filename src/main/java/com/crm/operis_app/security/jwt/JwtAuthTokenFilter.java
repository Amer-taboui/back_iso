...
import com.crm.operis_app.services.Utils.TransactionService;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            if (jwt != null && tokenProvider.validateJwtToken(jwt)) {
                ...
                String ipAdress = userRepository.getUserIpAdress(username);
                transactionService.saveTransaction(request, username, ipAdress);
